...
export function initChatApi() {
    ...
    chatEventRegistry.registerEvent<SendEventRequest, void>('send_event', async (req: SendEventRequest) => {
        sendEvent({
            name: req.eventName,
    ...
    chatEventRegistry.registerEvent<void, EditorContextResponse>('get_editor_context', async () => {
