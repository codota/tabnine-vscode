...
const connectionIssueError =
  "TabNine connection issues - Check your internet connection";
const cloudCapableNotEnabled =
...
export async function handleNotification(tabNine: TabNine) {
  ...
  if (is_cloud_capable && !cloud_enabled) {
    window.showInformationMessage(
      cloudCapableNotEnabled,
      "Enable the Deep Cloud"
    );
  }
}
