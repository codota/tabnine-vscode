...
export const TABNINE_DATA_FILE_NAME = "data.tabnine";

export const TABNINE_DATA_FILE_PATH = path.join(
  TABNINE_CONFIG_DIR,
  TABNINE_DATA_FILE_NAME
);
...
export const TABNINE_DATA_CONTEXT_KEY = "TABNINE_DATA";
