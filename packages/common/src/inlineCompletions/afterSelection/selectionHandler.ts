...
import CompletionOrigin from "../../binary/requests/CompletionOrigin";
import {
...
const HANDLE_IMPORTS = "tabnine-handle-imports";
export const SELECTION_COMPLETED = "tabnine-selection-completed";

// eslint-disable-next-line import/prefer-default-export
export function registerSelectionHandling(): Disposable {
  return Disposable.from(
    commands.registerTextEditorCommand(COMPLETION_IMPORTS, selectionHandler),
    commands.registerTextEditorCommand(HANDLE_IMPORTS, handleImports)
  );
}
